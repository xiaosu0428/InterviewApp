 ...
 * Date:
 * Author: XiaoSu
 * Desc: 分类》专业领域》点击某学科打开的Activity
 */
public class CategoryZMajorActivity extends AppCompatActivity implements View.OnClickListener, ExpandableListView.OnChildClickListener, ExpandableListView.OnGroupExpandListener {
    ...
    protected void bindViews() {
        ...
        Typeface typeface_wr_vista_ht = Typeface.createFromAsset(getAssets(), "font/wr_vista_ht.ttf");
        tv_title.setTypeface(typeface_wr_vista_ht);//vista黑体
